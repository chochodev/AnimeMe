...
import { Button, Flex, FormLabel, Grid, Icon, IconButton, Image, Input, InputGroup, InputLeftElement, Select, Text, Textarea } from '@chakra-ui/react';
import { FaAppleAlt } from 'react-icons/fa';

const EditPost = () => {
  return (
    <main>
        <Text as='h2' fontSize='2.25rem' fontWeight='600' color='secondary' w='max' m='0 auto'>Edit Anime Post</Text>
        <Flex as='form' action='' m='0 auto' p='.25rem' flexDir='column' w={{base:'100%', md:'70vw', lg:'55vw'}}>
            ...
            <Grid gridTemplateColumns='1fr 1fr'>
                ...
                <Flex flexDir='column' w='50%' p={{base:'.25rem', md:'.5rem'}}>
                    <FormLabel htmlFor='status' color='secondary' >Status</FormLabel>
                    <InputGroup>
                        <InputLeftElement>
                            <Icon as={FaAppleAlt} size='25' color='secondary' />
                        </InputLeftElement>
            ...
            <Button w='100%' borderRadius='.5rem' m='1rem auto'>Update Post</Button>
